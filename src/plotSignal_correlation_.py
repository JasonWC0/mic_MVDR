...
# 讀取原始 CSV 檔案並指定標題
file_path1 = './TDM1/mic1/wear4-1_timeDM.csv'
data1 = pd.read_csv(file_path1, header=None, names=['seconds', 'magnitude'], skiprows=1)
file_path3 = './PREPROCESSED_TDM_STEP01_1/mic1/wear4-1_timeDM.csv'
data3 = pd.read_csv(file_path3, header=None, names=['seconds', 'magnitude'], skiprows=1)
# 讀取準位均化後的 CSV 檔案
file_path2 = './MVDR_TDM1_FFT_SMOOTH/micAll_wear4_filtered.csv'
data2 = pd.read_csv(file_path2, header=None, names=['seconds', 'magnitude'], skiprows=1)
file_path4 = './MVDR_ANDLE_30_TDM1_FFT_SMOOTH/micAll_wear4_filtered.csv'
data4 = pd.read_csv(file_path4, header=None, names=['seconds', 'magnitude'], skiprows=1)
# 繪製對比波形
plt.figure(figsize=(10, 5))

# 原始波形
plt.plot(data1['seconds'], data1['magnitude'], label='raw signal')
plt.plot(data3['seconds'], data3['magnitude'], label='filtered signal')

# 準位均化後的波形
# plt.plot(data2['seconds'], data2['magnitude'], label='MVDR濾波對準訊號', linewidth=0.7)
# plt.plot(data4['seconds'], data4['magnitude'], label='MVDR濾波30度訊號', linewidth=0.7)

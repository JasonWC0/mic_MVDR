...
for i in range(1, 4):  # 根據需要更改範圍
    print(f'處理第 {i} 組數據...')

    # 讀取三個麥克風的數據
    mic_files = {
        'mic1': f'./PREPROCESSED_TDM/mic1/wear{i}-1_timeDM.csv',
        'mic2': f'./PREPROCESSED_TDM/mic2/wear{i}-2_timeDM.csv',
        'mic3': f'./PREPROCESSED_TDM/mic3/wear{i}-3_timeDM.csv'
    }
